...
def start_stat():
    ...
    while True:
        try:
            ...
            print(STAT_TPL % (cur_time(), str(round(cpu, 2)), str(round(avg_cpu, 2)), str(round(max_cpu, 2)) , str(round(mem, 2)), str(round(avg_mem, 2)), str(round(max_mem, 2)), spend_time, stat_count))
